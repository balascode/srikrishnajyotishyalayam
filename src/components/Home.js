...
t.from('.image2',{x:-100,duration:1})
  ...
  return (
    <div>
      ...
      <Container ref={Animatedcontainer}>
        <Row>
         <h1 className="text-start mb-4 about-us-title"> About Us </h1>
          <Col md={6} xs={12} ref={image1} className='order-1 order-md-1'>
            <img src={aboutImage} alt="About Sri Krishna Jyothishalayam Services" className="about-image"/>
          </Col>
          <Col md={6} xs={12} className='d-flex flex-column justify-content-center order-2 order-md-2'>
        ...
        <Row className='mt-3'>
          <Col md={6} xs={12} className='d-flex flex-column justify-content-center order-4 order-md-3'>
          ...
          <Col md={6} xs={12} ref={image2} className='order-3 order-md-4'>
      ...
      <div className="container services-complete p-5 shadow-lg">
       ...
       <div className="col-6 col-md-4 mb-4">
        ...
        <div className="service-card text-center d-flex flex-column">
          <div className="card">
            <div className='w-100 bgcmn'><img src={horoimg} className='bgh'/></div>
      ...
      <Link to="/services#Vastu" className="service-card-link">
        <div className="service-card text-center d-flex flex-column">
          <div className="card">
              <div className='w-100 bgcmn'><img src={vastuimg} className='bgv'/></div>
            <div className='highlight'>
      ...
      <Link to="/services#Numerology" className="service-card-link">
        <div className="service-card">
          <div className="card">
            <div className='w-100 bgcmn'><img src={numerologyimg} className='bgn'/> </div>
    ...
    <Link to="/services#Business" className="service-card-link">
        <div className="service-card">
          <div className="card">
            <div className='w-100 bgcmn'><img src={businessimg} className='bgbu'/></div>
      ...
      <Link to="/services#Medical" className="service-card-link">
        <div className="service-card">
          <div className="card">
            <div className='w-100 bgcmn'><img src={medicalimg} className='bgmd'/></div>
      ...
      <Link to="/services#Marriage" className="service-card-link">
        <div className="service-card">
          <div className="card">
            <div className='w-100 bgcmn'><img src={marriageimg} className='bgmarriage'/></div>
      ...
      <div id="review-section1" className="additional-section whole-container bgreview">
